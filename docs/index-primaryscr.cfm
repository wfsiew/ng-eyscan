...
<script>
	var tselected = "fn0_2";		//-- init current menu id
	...
	<main role="main" class="container-fluid ">
		<div class="container-fluid pt-4 pb-4 " >
			<div class="row main-body ">
				...
				<div class="nav flex-column nav-pills col-xl-2 col-lg-2 col-md-2 col-sm-12" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					
					<a class="nav-link active " id="pill_primary" data-toggle="pill" data-group="1" data-function="fn0_2"   href="#v-pills-user" 
						role="tab" aria-controls="v-pills-user" aria-selected="true">Primary Screeners</a>
					
					
					<a class="nav-link " id="pill_secondary" data-toggle="pill" data-group="2" data-function="fn0_3"  href="#v-pills-user" 
						role="tab" aria-controls="v-pills-user" aria-selected="false">Secondary Graders</a>
					
					<a class="nav-link " id="pill_prisec" data-toggle="pill" data-group="3" data-function="fn0_3"  href="#v-pills-user" 
						role="tab" aria-controls="v-pills-user" aria-selected="false">Primary/Secondary User</a>
									
					<a class="nav-link " id="pill_uadmin" data-toggle="pill" data-group="10" data-function="fn0_3"  href="#v-pills-user" 
						role="tab" aria-controls="v-pills-user" aria-selected="false">User Admin</a>
					
				</div>
				
				<div class="tab-content xp-4  col-xl-10 col-lg-10 col-md-10 col-sm-12" id="v-pills-tabContent">
					
					<div class="tab-pane fade show active " id="v-pills-user" role="tabpanel" >
						<div class="container-fluid" >
							<div class="row pb-2 justify-content-center">
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 h4">
									Primary Screeners 
								</div>
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 px-0 ">
								<form name="frmFilter" id="frmFilter" class="form-inline float-right" action="/bn_moh_uat/mnt/accounts/index.cfm?tid=fn0_2"  method="post">
									<input type="hidden" name="ugroup" id="ugroup" value="1">
									<input type="hidden" name="recno" id="recno" value="25" >
									<div class="form-group mr-2">
										
										<input name="desc" id="desc" type="text" class="form-control" placeholder="Search..." value="">
									</div>
									<div class="form-group mr-2">
										<div class="btn-toolbar float-right " >
											<button name="btnSearch" id="btnSearch" class="form-control btn bg-primary text-white" title="Search">
											<i class="fa fa-search"></i> Search</button>
										</div>
									</div>
									<div class="form-group">
										<div class="btn-toolbar float-right " >
											<button name="btnNew" id="btnNew" class="form-control btn bg-primary text-white" data-group="1" title="New">
							...
							<div class="row box-shadow">
								<div class="col-xl-12 col-lg-12 col-md-12 ">	
									...
									<div class="row p-1 bg-header text-white">
										<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">eMail <i class="fa fa-sort-up"></i></div>
										<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Full Name</div>
										<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Display Name</div>
										<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Company</div>
										<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12"></div>
									</div>
									
									
																					
											<div id="pg-1" class="rec-img row p-1 xborder-bottom bg-white text-dark" style='display: ;' >
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
												
												fatima@nova-hub.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Enerio Fatima</div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Fatima</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Mobile Bus 1</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_1" name="pedit" class="pedit" href="" data-id="4" data-group="1" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-2" class="rec-img row p-1 xborder-bottom bg-light text-dark" style='display: ;' >
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
												
												novahealth.primary@outlook.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">novahealth primary</div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Primary Screener</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Mobile Bus 1</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_2" name="pedit" class="pedit" href="" data-id="30" data-group="1" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-3" class="rec-img row p-1 xborder-bottom bg-white text-dark" style='display: ;' >
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
												
												novahealth.primary2@outlook.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Two Primary Screener </div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Primary Screener Two</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Muara Health Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_3" name="pedit" class="pedit" href="" data-id="32" data-group="1" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-4" class="rec-img row p-1 xborder-bottom bg-light text-dark" style='display: ;' >
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
												
												novahealth.primary3@outlook.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Three Primary Screener </div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">P Screener Three</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Temburong Hospital</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_4" name="pedit" class="pedit" href="" data-id="34" data-group="1" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-5" class="rec-img row p-1 xborder-bottom bg-white text-dark" style='display: ;' >
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
												
												novahealth.primary4@outlook.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Four Primary Screener </div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">PrimaryScreenerFour</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">RIPAS Hospital (TOPCON)</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_5" name="pedit" class="pedit" href="" data-id="35" data-group="1" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-6" class="rec-img row p-1 xborder-bottom bg-light text-dark" style='display: ;' >
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
												
												novahealth.primary5@outlook.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Five Primary Screener </div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">PScreenerFive</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Rimba Health Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_6" name="pedit" class="pedit" href="" data-id="36" data-group="1" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-7" class="rec-img row p-1 xborder-bottom bg-white text-dark" style='display: ;' >
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
												
												pscreener@gmail.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">j screener</div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">pscreener</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Muara Health Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_7" name="pedit" class="pedit" href="" data-id="37" data-group="1" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
									...
									<div class="col-lg-4 col-md-4 col-sm-12 py-2">
										...
										<select class="form-control form-control-sm custom-select custom-select-sm" name="pagerec" id="pagerec" style="max-width: 80px;" >
									...
									<div class="col-lg-4 col-md-4 col-sm-12 pt-2 text-center">
										...
										<span id="dispdesc" class="text-muted">Showing 1 to 7 of 7</span>
									</div>
...
var vpagerec = parseInt("25");			//-- number of records that can be displayed by page
var vtotpages = parseInt("1");		//-- calculated total number of pagination buttons
...
$(function(){
	...
	$("#pill_primary, #pill_secondary, #pill_prisec, #pill_uadmin").on('click',function(e){
		e.preventDefault();
		
		$("#ugroup").val( $(this).data("group") );
		
		var vfuncid = $(this).data("function");
		var vaction = "/bn_moh_uat/mnt/accounts/index.cfm?tid=" + vfuncid;
    	$("#frmFilter").attr('action', vaction);
	...
	$("#btnNew").on('click',function(e){
		e.preventDefault();
		var vgroup = $(this).data('group');
		
		var vsrc = "/mnt/accounts/accounts_form.cfm?title=New&noreturn=Y&tgrp=" + vgroup;
		var vparams = "";
		var viframesetting = "w700h580";
		...
		popWindow(vsrc, vparams, viframesetting).then(function(answer){			//'Prompt user before rerouting')
			if(answer == 'ok'){
				...
				var vmsgtxt = "User Account";
				displayMsg(vmsgno, vmsgtxt).then(function(){
					top.location.href="/bn_moh_uat/mnt/accounts/index.cfm?tgrp=" + vgroup; 
				});
			}
		})
	...
	$(".pedit").on('click',function(e){
		...
		var vsrc = "/mnt/accounts/accounts_form.cfm?id=" + vid + "&title=Edit";
		var vparams = "";
		var viframesetting = "w700h580";
	...
	$(".resetacc").on('click',function(e){
		e.preventDefault();
		
		var vid = $(this).data('id');
		
		var vsrc = "/mnt/accounts/reset_user_form.cfm?id=" + vid + "&title=Reset"
		var vparams = "";
		var viframesetting = "w500h310";
	...
	$(".page-item").on('click',function(e){
		...
		$("#dispdesc").text("Showing " + vstart + " to " + vend + " of " + 7);
				  ...
				  <script>
				  		...
				  		function windowResize(){
							...
							if (sessionStorage.getItem('sessionid') === null){
								sessionStorage.setItem('sessionid', '2F42CB8561132DCCC23176E4D693486D_2100447_d81733153e5e7e73-B01882B9-0593-DEDE-3155B64B95B46F01');
								sessionStorage.setItem('event_id', '20250108003741');
							}
							else if (sessionStorage.getItem('sessionid') != '2F42CB8561132DCCC23176E4D693486D_2100447_d81733153e5e7e73-B01882B9-0593-DEDE-3155B64B95B46F01'){
								var t_event_id = '0';
