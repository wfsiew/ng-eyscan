		...
		<div class="container-fluid pt-4 pb-4 " >
			<div class="row main-body ">
				...
				<div class="nav flex-column nav-pills col-xl-2 col-lg-2 col-md-2 col-sm-12" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link active " id="pill_prisec" data-toggle="pill" data-group="3" data-function="fn0_3"  href="#v-pills-user" 
						...
						<div class="container-fluid" >
							<div class="row pb-2 justify-content-center">
								...
								<form name="frmFilter" id="frmFilter" class="form-inline float-right" action="/bn_moh_uat/mnt/accounts/index.cfm?tid=fn0_3"  method="post">
									<input type="hidden" name="ugroup" id="ugroup" value="3">
									...
									<div class="form-group">
										<div class="btn-toolbar float-right " >
											<button name="btnNew" id="btnNew" class="form-control btn bg-primary text-white" data-group="3" title="New">
								...
								<div class="col-xl-12 col-lg-12 col-md-12 ">	
									...
									<div class="row p-1 bg-header text-white">
										...
										<div class="row py-1 xborder-bottom text-center bg-white">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">No Record Found.</div>
										</div>
...
$(function(){
	...
	$(".page-item").on('click',function(e){
		...
		$("#dispdesc").text("Showing " + vstart + " to " + vend + " of " + 0);
