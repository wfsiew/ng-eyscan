...
<script>
	var tselected = "fn0_3";		//-- init current menu id
		...
		<div class="container-fluid pt-4 pb-4 " >
			<div class="row main-body ">
				...
				<div class="nav flex-column nav-pills col-xl-2 col-lg-2 col-md-2 col-sm-12" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link " id="pill_primary" data-toggle="pill" data-group="1" data-function="fn0_2"   href="#v-pills-user" 
						role="tab" aria-controls="v-pills-user" aria-selected="true">Primary Screeners</a>
					
					
					<a class="nav-link active " id="pill_secondary" data-toggle="pill" data-group="2" data-function="fn0_3"  href="#v-pills-user" 
					...
					<div class="tab-pane fade show active " id="v-pills-user" role="tabpanel" >
						<div class="container-fluid" >
							<div class="row pb-2 justify-content-center">
								...
								<form name="frmFilter" id="frmFilter" class="form-inline float-right" action="/bn_moh_uat/mnt/accounts/index.cfm?tid=fn0_3"  method="post">
									<input type="hidden" name="ugroup" id="ugroup" value="2">
									...
									<div class="form-group">
										<div class="btn-toolbar float-right " >
											<button name="btnNew" id="btnNew" class="form-control btn bg-primary text-white" data-group="2" title="New">
									...
									<div class="row p-1 bg-header text-white">
										...
										<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12"></div>
											...
											<div id="pg-1" class="rec-img row p-1 xborder-bottom bg-white text-dark" style='display: ;' >
												...
												dr.helena@jpmc.com.bn
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Hurairah Helena </div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Dr Helena</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Brunei MOH Ocular Reading Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_1" name="pedit" class="pedit" href="" data-id="14" data-group="2" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-2" class="rec-img row p-1 xborder-bottom bg-light text-dark" style='display: ;' >
												...
												dummytesting.eyris@outlook.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Grader Secondary</div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Secondary Grader</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Brunei MOH Ocular Reading Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_2" name="pedit" class="pedit" href="" data-id="31" data-group="2" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-3" class="rec-img row p-1 xborder-bottom bg-white text-dark" style='display: ;' >
												...
												dummytesting.eyris2@outlook.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Two Secondary Grader</div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Secondary Grader Two</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Brunei MOH Ocular Reading Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_3" name="pedit" class="pedit" href="" data-id="33" data-group="2" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-4" class="rec-img row p-1 xborder-bottom bg-light text-dark" style='display: ;' >
												...
												eyeman3333@gmail.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Joshi Nayan</div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Mr Nayan Joshi</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Brunei MOH Ocular Reading Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_4" name="pedit" class="pedit" href="" data-id="11" data-group="2" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-5" class="rec-img row p-1 xborder-bottom bg-white text-dark" style='display: ;' >
												...
												helena.hurairah@moh.gov.bn
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Hajah Helena </div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Dr Hajah Helena </div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Brunei MOH Ocular Reading Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_5" name="pedit" class="pedit" href="" data-id="12" data-group="2" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-6" class="rec-img row p-1 xborder-bottom bg-light text-dark" style='display: ;' >
												...
												novahealth.chingsoo@outlook.com
												</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Chew CS</div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">Secondary Grader</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Brunei MOH Ocular Reading Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_6" name="pedit" class="pedit" href="" data-id="29" data-group="2" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
											...
											<div id="pg-7" class="rec-img row p-1 xborder-bottom bg-white text-dark" style='display: ;' >
												...
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">grader sgrader</div>
												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">sgrader</div>
												<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">Brunei MOH Ocular Reading Centre</div>
												<div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 text-center " >
													<a id="pedit_7" name="pedit" class="pedit" href="" data-id="24" data-group="2" title="Edit"><i class="fa fa-pencil-alt "></i></a>
												</div>
											</div>
